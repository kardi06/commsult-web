            ...
            <div class="container clearfix cs-expanded-side-clear">
                <div class="row cs-expanded-side-clear">
                        ...
                        <a href="#"><?xml version="1.0" encoding="UTF-8"?>
                            <svg width="154px" height="15px" viewBox="0 0 154 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Header-blau-default" transform="translate(-134.000000, -18.000000)" fill="#FFFFFF">
                                        ...
                                        <div class="container clearfix">
                                            <div class="row">
                                                <div class="cs-dropdown-logo col-lg-2">
                                                    <a id="sap" href="#">
                                                        <img src="{{asset('images/ontego_subline.svg')}}" alt="Ontego SAP Mobility">
                                                    </a>
                                                </div>
                                                <div class="cs-dropdown-submenu-wrapper col-lg-10">
                                                    <div class="cs-dropdown-submenu">
                                                        <a id="sapFunktionen" href="#">
                                                            <div class="cs-dropdown-submenu-title"><span style="margin-right: 10px;">Functions</span>
                                                            </div>
                                                        </a>
                                                        <ul>
                                                            <li>
                                                                <a id="sapFunktionenUser" href="#">
                                                                    <div>User Experience</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapFunktionenTemplate" href="#">
                                                                    <div>Template Principle</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapFunktionenIntegration" href="#">
                                                                    <div>SAP Integration</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapFunktionenOffline" href="#">
                                                                    <div>Offline &amp; Sync+</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapFunktionenErp" href="3">
                                                                    <div>ERP Extension</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapFunktionenDesign" href="#">
                                                    ...
                                                    <div class="cs-dropdown-submenu">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a id="sapEinsatzLager" href="#">
                                                                    <div>Warehouse Logistic</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapEinsatzProdukt" href="#">
                                                                    <div>Production</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapEinsatzInventur" href="#">
                                                                    <div>Inventory</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapEinsatzService" href="#">
                                                                    <div>Service Management</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapEinsatzInstand" href="#">
                                                                    <div>Maintenance</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="sapEinsatzWeitere" href="#">
                                                                    <div>Other Area</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="cs-dropdown-submenu">
                                                        ...
                                                        <p>
                                                            Mobile hardware for my employees find.
                                                        </p>
                                            ...
                                            <div class="row">
                                                <div class="cs-dropdown-submenu-wrapper col-lg-10 offset-lg-2">
                                                    <div class="cs-dropdown-submenu">
                                                        ...
                                                        <p>
                                                            Why Businesses on Ontego Business Mobility .
                                                        </p>
                                                    </div>
                                                    <div class="cs-dropdown-submenu">
                                                        <a id="warumEins" href="#">
                                                            <div class="cs-dropdown-submenu-title">
                                                                <span>In The Use</span>
                                                            </div>
                                                        </a>

                                                        <ul>
                                                            <li>
                                                                <a id="warumReferenzen" href="#">
                                                                    <div>Reference</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="cs-dropdown-submenu">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a id="warumDasUnter" href="#">
                                                                    <div>Companies</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="warumDasStand" href="#">
                                                                    <div>Location</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a id="warumKarriere" href="#">
                                            ...
                                            <div class="row">
                                                <div class="cs-dropdown-submenu-wrapper col-lg-10 offset-lg-2">
                                                    <div class="cs-dropdown-submenu">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="#" id="vlbLogistik">
                                                                    <div>VLB Logistics congress 2024</div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" id="logimat2024">
                                                ...
                                                <div class="cs-dropdown-submenu-wrapper col-lg-10 offset-lg-2">
                                                    <a href="#">
                                                        <div class="cs-dropdown-submenu">
                                                            ...
                                                            <p>
                                                                Information and tips about MDE for SAP and other ERP systems.
                                                            </p>
                                                        </div>
                                                    </a>
                                                </div>
                    ...
                    <div id="cs-demo-button" class="col-lg-2">
                        <div class="cs-button cs-button-arrow cs-button-white">
                            Demo Request</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="cs-dropdown-submenu-wrapper col-lg-10">
                        <div class="cs-tabs clearfix">
                            <ul class="tab-nav clearfix">
                                <li><a href="#" id="sapFunktionen">
                                        <div class="cs-dropdown-submenu-title"><span>Function</span></div>
                                    </a></li>
                                <li><a href="#" id="sapEinsatz">
                                        <div class="cs-dropdown-submenu-title"><span>Area Of Application</span>
                                        </div>
                                    </a></li>
                                <li class="cs-initial-active-tab"><a href="#" id="sapMobile">
                                        <div class="cs-dropdown-submenu-title"><span>Mobile Device</span></div>
                                    </a></li>
                            </ul>
                            <div class="tab-container">
                                <div class="tab-content clearfix" id="tab-1">
                                    <ul>
                                        <li>
                                            <a href="#" id="sapFunktionenUser">
                                                <div>User Experience</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapFunktionenTemplate">
                                                <div>Template Principle</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapFunktionenIntegration">
                                                <div>SAP Integration</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapFunktionenOffline">
                                                <div>Offline &amp; Sync+</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapFunktionenErp">
                                                <div>ERP Extensions</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapFunktionenDesign">
                                                <div>Ontego Designer</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="tab-content clearfix" id="tab-2">
                                    <ul>
                                        <li>
                                            <a href="#" id="sapEinsatzLager">
                                                <div>WareHouse Logistic</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapEinsatzProdukt">
                                                <div>Production</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapEinsatzInventur">
                                                <div>Inventory</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapEinsatzService">
                                                <div>Service Management</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapEinsatzInstand">
                                                <div>Maintenance</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" id="sapEinsatzWeitere">
                                                <div>Other Area</div>
                                            </a>
                                        </li>
                                    </ul>
